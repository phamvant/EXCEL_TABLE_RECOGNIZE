...
import vietocr_structure.backbone.vgg as vgg
from vietocr_structure.backbone.resnet import Resnet50
from vietocr_structure.backbone.resnet_fpn import resnet_fpn
